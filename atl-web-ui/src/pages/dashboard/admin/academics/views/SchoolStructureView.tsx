...
const SchoolStructureView: React.FC = () => {
    ...
    // Removed getTerm as this is school specific now
    ...
    const handleAddSemester = async (clsId: string, progId: string, currentOffCount: number) => {
        ...
        try {
            ...
            const offName = `${clsName} - ${String.fromCharCode(65 + currentOffCount)}`;
            const offeringType = 'SCHOOL_CLASS';
                                                            ...
                                                            {(() => {
                                                                ...
                                                                if (groupsCount > 3) {
                                                                    return (
                                                                        ...
                                                                        >
                                                                            {expandedBranches[cls.id] ? 'Show Less' : `View All ${groupsCount} Sections`}
                                                                        </button>
                                                                    );
                                                                }
                                                                return null;
...
export default SchoolStructureView;
