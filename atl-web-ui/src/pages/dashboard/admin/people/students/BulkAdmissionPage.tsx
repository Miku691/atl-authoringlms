...
const BulkAdmissionPage: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-2xl font-bold text-gray-900">Bulk Admission</h1>
            <p className="text-gray-500">Upload JSON data to admit multiple students at once.</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="h-64 overflow-y-auto border rounded-lg bg-gray-50 p-2">
