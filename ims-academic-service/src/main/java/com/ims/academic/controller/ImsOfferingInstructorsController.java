...
public class ImsOfferingInstructorsController {
        ...
        public ResponseEntity<ApiResponse<ImsOfferingInstructorsDto>> create(
                        @RequestBody ImsOfferingInstructorsDto dto) {
        ...
        @PreAuthorize("@securityService.canMarkAttendance(#instructorId)")
        public ResponseEntity<ApiResponse<List<ImsOfferingInstructorsDto>>> getByInstructorId(
