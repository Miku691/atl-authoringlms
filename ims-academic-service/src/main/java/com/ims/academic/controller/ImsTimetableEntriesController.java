...
public class ImsTimetableEntriesController {
        ...
        @PutMapping("/{id}")
        public ResponseEntity<ApiResponse<ImsTimetableEntriesDto>> update(@PathVariable String id,
                        @RequestBody ImsTimetableEntriesDto dto) {
        ...
        public ResponseEntity<ApiResponse<List<ImsTimetableEntriesDto>>> getByInstructorId(
                ...
                return ResponseEntity.ok(
                                ApiResponse.<List<ImsTimetableEntriesDto>>builder()
                                                .status("SUCCESS")
                                                .statusCode(HttpStatus.OK.value())
                                                .message("Instructor Timetable fetched successfully")
